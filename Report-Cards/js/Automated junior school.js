...
// Global variables for Firebase imports and alication state
let firebaseImports;
let studentsData = [];
let db;
let auth;
...
subjects: ['English', 'Kiswahili','Mathematics','Integrated Science', 'Agriculture',  'Social studies','CRE', 'Creative Arts & Sports','Pre-Technical Studies',],    gradeScale: [
...
const TEACHER_REMARKS_CONFIG = {
    ranges: [
        { 
            ...
            max: 100, 
            remarks: [
                "Brilliant work this term! Your dedication and passion for learning shine through in everything you do. Keep soaring!",
                "What an incredible term! You have shown outstanding commitment and your results reflect your amazing effort. We are very proud of you!",
                "You have truly excelled this term! Your enthusiasm and hard work inspire everyone around you. Keep up this wonderful spirit!",
                "Fantastic achievement! You approached every subject with great energy and determination. You are a true star — keep it up!",
                "What a superb term you have had! Your positive attitude and love for learning are truly admirable. The sky is your limit!"
            ]
        },
        { 
            min: 75, 
            max: 89, 
            remarks: [
                "You have had a great term! Your hard work and commitment are clearly paying off. Keep pushing forward — even greater things await you!",
                "Well done on a wonderful term! You have shown real growth and determination. Believe in yourself and keep building on this strong foundation!",
                "Impressive performance this term! You tackled your studies with focus and resilience. Stay motivated and your efforts will continue to bear fruit!",
                "You should be very proud of yourself this term! Your consistent effort and positive attitude have made a real difference. Keep going strong!",
                "Excellent effort this term! You have shown that with dedication and a positive mindset, great results follow. Keep nurturing that wonderful attitude!"
            ]
        },
        { 
            min: 58, 
            max: 74, 
            remarks: [
                "Good work this term! You have shown real effort and growth in many areas. With continued focus and belief in yourself, even greater results are coming!",
                "You have made solid progress this term and that is something to celebrate! Keep up your positive energy and the best is yet to come!",
                "A commendable term! You worked steadily and showed great determination. Keep exploring and asking questions — you have so much potential!",
                "You have put in good effort this term and it shows! Stay curious, stay determined, and your hard work will take you to even greater heights next term!",
                "Well done on a productive term! You are growing and learning every day. Keep that wonderful spirit alive and exciting progress is ahead of you!"
            ]
        },
        { 
            min: 41, 
            max: 57, 
            remarks: [
                "You have shown real courage and effort this term and that matters deeply! With extra practice and belief in your abilities, wonderful improvement is on the way!",
                "Every great achiever started exactly where you are now! You have taken important steps this term and with continued effort, bright days are ahead. Keep going!",
                "You have a lot of wonderful potential and this term you have begun to show it! Stay positive, keep asking for help when needed, and great progress awaits you!",
                "Your journey of growth is well underway! This term you showed determination and resilience. Channel that energy into your studies and the results will follow!",
                "You are capable of amazing things! This term showed us your fighting spirit. Keep nurturing that strength, seek support when needed, and you will shine brightly!"
            ]
        },
        { 
            min: 31, 
            max: 40, 
            remarks: [
                "We believe in you wholeheartedly! This term has been a chance to grow and next term is a fresh opportunity to show the world what you are truly made of. Keep going!",
                "You have so much wonderful potential inside you! Let this term inspire you to reach out for support, study with energy, and watch yourself transform next term!",
                "Every champion faces challenges and you are no different! Use this term as your motivation to rise higher. With support and determination, great things await you!",
                "You are stronger than you know! This term has been a learning experience and that is valuable. Embrace extra help, stay positive, and a brighter term is ahead!",
                "We see your potential and we are fully in your corner! Let this term fuel your hunger to improve. With the right support and effort, you will surprise everyone!"
            ]
        },
        { 
            min: 0, 
            max: 30, 
            remarks: [
                "We care deeply about your success and believe you have untapped potential waiting to shine! Let next term be your turning point — with support and determination, great change is possible!",
                "Every great story has a challenging chapter and this can be yours to learn from! You are valued and capable. Embrace every opportunity for support and let next term be your comeback!",
                "You are full of potential and we have not given up on you — not even close! Let this term inspire a fresh commitment. With courage and support, a much brighter term is within reach!",
                "This term is not the end of your story — it is the beginning of your comeback! You are capable of remarkable growth. Reach out, work hard, and let next term show your true strength!",
                "We see the best in you and we know you can rise above any challenge! Let this term ignite your determination. With extra effort and the support around you, wonderful progress is coming!"
            ]
        }
    ]
};
...
const totalPoints = scores.reduce((sum, score) => {
    return sum + parseFloat(getGradeFromScore(score).grade);
}, 0);

const maxPoints = scores.length * 8.0;  // 8.0 is the maximum points per subject

return {
    total: total.toFixed(2),
    totalPoints: `${totalPoints.toFixed(1)}/${maxPoints.toFixed(1)}`,
...
doc.setFont(undefined, 'bold');
doc.setFontSize(9);
doc.text('CLOSING DATE: ................| OPENING DATE: ............', 100, yPos);
    ...
    const headers = [['Code', 'Learning Area', 'Score', 'Points', 'Performance', 'Comment']];
const tableData = [];

// Subject codes matching the order in REPORT_CARD_CONFIG.subjects
const subjectCodes = {
    'Mathematics':                                    '903',
    'English':                               '901',
    'Kiswahili':                                '902',
    ...
    'Agriculture':                                    '906',
    'CRE':                  '908',
    'Creative Arts & Sports':                                  '911',
    'Social studies':                                 '907'
};

// Performance label extracted from comment (e.g. "EE1", "ME2", "AE1", "BE2")
function getPerformanceCode(comment) {
    const match = comment.match(/\b(EE|ME|AE|BE)\d\b/);
...
REPORT_CARD_CONFIG.subjects.forEach(subject => {
    ...
    const performanceCode = getPerformanceCode(gradeInfo.comment);

    tableData.push([
        subjectCodes[subject] || '---',   // Code
        subject,                           // Learning Area
        isNaN(numScore) ? 'N/A' : numScore.toString(),  // Score
        gradeInfo.grade,                   // Points
        performanceCode,                   // Performance e.g. ME1, EE2
        gradeInfo.comment                  // Full Comment e.g. Meeting Expectation ME1
    ]);
});
    ...
    doc.autoTable({
        ...
        columnStyles: {
    0: { cellWidth: 15, },   // Code
    1: { cellWidth: 46 },                      // Learning Area
    2: { cellWidth: 20, },    // Score
    3: { cellWidth: 20, },    // Points
    4: { cellWidth: 24, },    // Performance
    5: { cellWidth: 55 }                       // Comment
}
    });
    ...
    const summaryInfo = [
    [`Total Points: ${stats.totalPoints}`, `Score Average: ${stats.average}%`],
    [`Avg Points: ${stats.grade}`, `Learning Areas Assessed: ${stats.assessedSubjects}`],
        [`Avg Rubric Indicator: ${stats.comment}`, `Position: ${student['Position'] || 'N/A'}`]
    ];
...
function extractGrade(gradeString) {
    ...
    return new Promise((resolve) => {
        ...
        for (let i = 0; i < studentsToProcess.length; i++) {
            ...
            combinedDoc.setFont(undefined, 'bold');
            combinedDoc.setFontSize(9);
            combinedDoc.text('CLOSING DATE:.............| OPENING DATE: ...........', 100, yPos);
...
String(calculateStudentStats(student).totalPoints || 'N/A'),
