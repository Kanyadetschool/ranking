...
const REPORT_CARD_CONFIG = {
    subjects: ['Mathematics', 'English Language', 'Kiswahili Lugha','Kiswahili (Insha na Utangulizi wa Fasihi)','Pre-Technical Studies', 'Integrated Science','Agriculture', 'Creative Arts', 'Social studies'],
    gradeScale: [
...
async function generateStudentReportCard(student, includeWatermark = false) {
    if (!window.jspdf) {
