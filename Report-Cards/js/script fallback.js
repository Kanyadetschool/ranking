...
const REPORT_CARD_CONFIG = {
    ...
    gradeScale: [
        { min: 80, max: 100, grade: 'A', comment: 'Exceeds Expectation E1' },
        { min: 75, max: 79, grade: 'A-', comment: 'Exceeds Expectation E2' },
        { min: 70, max: 74, grade: 'B+', comment: 'Meets Expectation M1' },
        { min: 61, max: 69, grade: 'B', comment: 'Meets Expectation M2' },
        { min: 56, max: 60, grade: 'B-', comment: 'Meets Expectation M3' },
        { min: 51, max: 55, grade: 'C+', comment: 'Approaches Expectation A1' },
        { min: 46, max: 50, grade: 'C', comment: 'Approaches Expectation A2' },
        { min: 41, max: 45, grade: 'C-', comment: 'Approaches Expectation A3' },
        { min: 36, max: 40, grade: 'D+', comment: 'Below Expectation B1' },
        { min: 31, max: 35, grade: 'D', comment: 'Below Expectation B2' },
        { min: 26, max: 30, grade: 'D-', comment: 'Below Expectation B3' },
        { min: 0, max: 25, grade: 'E', comment: 'Below Expectation B4' }
    ]
};
...
async function generateStudentReportCard(student, includeWatermark = true) {
    ...
    const summaryInfo = [
        ...
        [`Overall Grade: ${stats.grade}`, `Learning Areas Assessed: ${stats.assessedSubjects}`],
    ...
    //     doc.setFontSize(60);
    //     doc.text('ICT DEPT', pageWidth / 2, pageHeight / 2, {
    //         align: 'center',
    //         angle: 45
    //     });
    // }
